...
import com.example.snowisland.service.NightActionService;
...
@RestController
@RequestMapping("/api/night-actions")
@CrossOrigin(origins = "*")
public class NightActionController {
    ...
    public ResponseEntity<Map<String, Object>> getContext(
        ...
        return ResponseEntity.ok(nightActionService.getContext(playerId, gameDay));
    }
    ...
    public ResponseEntity<Map<String, Object>> submit(@RequestBody Map<String, Object> body) {
        ...
        return ResponseEntity.ok(nightActionService.submitAction(playerId, actionType, payload, gameDay));
    }
    ...
    public ResponseEntity<List<Map<String, Object>>> getAll(
        ...
        return ResponseEntity.ok(nightActionService.getAllActions(gameDay, faction, status));
    }
    ...
    public ResponseEntity<Map<String, Object>> feedback(
        ...
        return ResponseEntity.ok(nightActionService.feedbackAction(actionId, feedback));
    }
