...
public final class PlayerStatusCatalog {
    ...
    public static List<Map<String, Object>> buildStatusList(Player player) {
        ...
        if (Boolean.TRUE.equals(player.getIsInjured())) {
    ...
    public static boolean combatMeleeDisabled(Player player) {
        ...
        if (Boolean.TRUE.equals(player.getIsDead()) || Boolean.TRUE.equals(player.getIsSeverelyInjured())) {
            return true;
        }
        return Boolean.TRUE.equals(player.getIsWeak()) || Boolean.TRUE.equals(player.getIsInjured());
    }
    ...
    public static Map<String, Object> combatFlags(Player player) {
        ...
        m.put("isDead", Boolean.TRUE.equals(player.getIsDead()));
        m.put("isSeverelyInjured", Boolean.TRUE.equals(player.getIsSeverelyInjured()));
        m.put("isWeak", Boolean.TRUE.equals(player.getIsWeak()));
        m.put("isInjured", Boolean.TRUE.equals(player.getIsInjured()));
