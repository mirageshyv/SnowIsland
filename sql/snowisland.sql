...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='抽取牌记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COMMENT='阵营行动表';
...
INSERT INTO `material` VALUES ('5', '食物', 'kg', '通用食物（千克）', '2026-04-27 11:36:23', '2026-05-16 12:00:00');
...
INSERT INTO `material` VALUES ('8', '煤油', '升', '基础照明取暖燃料', '2026-04-27 11:36:23', '2026-05-17 00:00:00');
...
-- ----------------------------
INSERT INTO `milestone` VALUES ('1', '团结平民', '星星之火也可以燎原\r\n反抗者拥有一个初始协议书。\r\n反抗者应当与更多的玩家讨论，明确对方的特性，资源，加入阵营的意向，并且对其进行观察，辨别可能的内鬼。\r\n当包括初始反抗者在内的确认加入反抗者名单大于等于8人后（以签订了契约加入微信群聊为准，以死亡玩家应也计算在内），该里程碑事件完成。', '1', '2026-05-19 19:36:32', '1', '2026-05-14 10:40:18', '2026-05-19 19:38:11');
INSERT INTO `milestone` VALUES ('2', '解放我们的同伴', '铁窗锁不住自由的心。目前在监狱里面的同伴都是曾经为了我们的革命事业献出自由乃是生命的同志。所以解放他们对于我们来讲至关重要。解救身在监狱中的那些同伴，他们将继续加入你们，并点燃这个岛上平民心中对于自由的渴望。当同伴被解救出来，该里程碑事件完成。', '1', '2026-05-19 19:36:33', '2', '2026-05-14 10:40:18', '2026-05-19 19:36:33');
...
INSERT INTO `milestone` VALUES ('4', '反抗不是我们的目的，平等才是', '不给人活路，那就掀桌子。你们或联系任意你们信任的人。向统治者进行施压，要求调整劳工名单或者让统治者分配一定的资源给其他镇民。当该施压投票超过半数被统治者同意，该里程碑事件完成。', '1', '2026-05-19 19:36:34', '4', '2026-05-14 10:40:18', '2026-05-19 19:36:34');
...
INSERT INTO `player` VALUES ('2', '莉莉丝', '0', '1', '0', '2', '2', '反叛者', '2026-04-26 22:13:35', '2026-05-19 14:32:41');
INSERT INTO `player` VALUES ('3', '罗宾', '1', '1', '0', '3', '3', '冒险者', '2026-04-26 22:13:35', '2026-05-19 15:08:33');
INSERT INTO `player` VALUES ('4', '亚瑟', '0', '0', '2', '4', '4', '天灾使者', '2026-04-26 22:13:35', '2026-05-19 14:53:10');
INSERT INTO `player` VALUES ('5', '艾米丽', '0', '1', '0', '5', '5', '平民', '2026-04-26 22:13:35', '2026-05-19 15:08:33');
INSERT INTO `player` VALUES ('6', '测试', '0', '1', '1', '2', '2', '平民', '2026-04-29 01:14:41', '2026-05-19 15:08:33');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='已选择的天灾牌表';
...
CREATE TABLE `shelter_daily_labor` (
  ...
  KEY `idx_game_day` (`game_day`),
  KEY `shelter_daily_labor_ibfk_1` (`player_id`),
  CONSTRAINT `shelter_daily_labor_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `player` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='避难所每日劳工名单（总建造值=SUM(build_value)）';

-- ----------------------------
-- Records of shelter_daily_labor
-- ----------------------------
INSERT INTO `shelter_daily_labor` VALUES ('1', '1', '3', '7', '1', '0', '2026-05-19 12:09:47');
INSERT INTO `shelter_daily_labor` VALUES ('2', '1', '5', '4', '0', '0', '2026-05-19 12:09:47');
INSERT INTO `shelter_daily_labor` VALUES ('3', '2', '2', '0', '0', '1', '2026-05-19 12:56:09');
INSERT INTO `shelter_daily_labor` VALUES ('4', '2', '6', '7', '1', '0', '2026-05-19 12:56:09');
INSERT INTO `shelter_daily_labor` VALUES ('5', '2', '3', '4', '0', '0', '2026-05-19 12:56:09');
INSERT INTO `shelter_daily_labor` VALUES ('6', '2', '5', '4', '0', '0', '2026-05-19 12:56:09');
...
INSERT INTO `warehouse_armory` VALUES ('9', 'item', '6', '2', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
-- ----------------------------
INSERT INTO `warehouse_dock` VALUES ('1', 'material', '5', '100', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
INSERT INTO `warehouse_dock` VALUES ('5', 'item', '1', '1', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
INSERT INTO `warehouse_dock` VALUES ('8', 'weapon', '6', '1', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
INSERT INTO `warehouse_dock` VALUES ('12', 'material', '11', '1', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
CREATE TABLE `warehouse_fuel` (
  ...
  KEY `idx_item_type` (`item_type`),
  KEY `idx_item_id` (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='仓库-燃料仓库（警察局）';

-- ----------------------------
-- Records of warehouse_fuel
-- ----------------------------
INSERT INTO `warehouse_fuel` VALUES ('1', 'material', '8', '150', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
INSERT INTO `warehouse_fuel` VALUES ('2', 'material', '2', '50000', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
INSERT INTO `warehouse_fuel` VALUES ('5', 'item', '2', '2', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
CREATE TABLE `warehouse_general` (
  ...
  KEY `idx_item_type` (`item_type`),
  KEY `idx_item_id` (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='仓库-矿场仓库';
...
INSERT INTO `warehouse_general` VALUES ('3', 'material', '4', '80', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
INSERT INTO `warehouse_general` VALUES ('4', 'material', '3', '60', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
INSERT INTO `warehouse_general` VALUES ('5', 'material', '9', '20', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
INSERT INTO `warehouse_general` VALUES ('8', 'item', '8', '1', '2026-05-17 00:00:00', '2026-05-17 00:00:00');
...
CREATE TABLE `warehouse_rebel` (
  ...
  KEY `idx_item_type` (`item_type`),
  KEY `idx_item_id` (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='仓库-反抗者阵营仓库';
...
-- Records of weapon
-- ----------------------------
INSERT INTO `weapon` VALUES ('1', '制式手枪', '把', '标准配备', '5', '2026-04-27 11:36:23', '2026-05-19 22:49:10');
